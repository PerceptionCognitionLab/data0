...
#define stimperblock 2
#define numblocks 1
#define numlength 2
#define breaklength 10
#define fore_time 30
...
// int blocktypem={0,1};
  double length[numlength]={.85,1};
  int lengthsa[stimperblock]={0,1};
  int lengthsb[stimperblock]={0,1};
...
//  picbufout(picBuf,dump);
  ...
  counter++;
	...
	data=runMovie(stim_m, UNTIL_RESPONSE,1);
	  ...
	  if (resp==12) {CleanupMoviePackage();
