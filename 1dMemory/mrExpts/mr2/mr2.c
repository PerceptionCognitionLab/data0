  ...
  if (feedback==2)
   {
    ...
    drawText("Count on the Beep",xcenter-80,ycenter+20,0,255);
    }
  if (feedback==1)
   {
    drawText("Correct Answer",xcenter-80,ycenter,0,255);
    drawText("Count on the Beep",xcenter-80,ycenter+20,0,255);
    }

  uploadImage(instruct_i);
  setMovie(instruct_m,0,instruct_i,24);
  runMovie(instruct_m,UNTIL_RESPONSE,1);
